...
<head>
    ...
    <!-- Favicon-->
    <link rel="icon" href="vendor/adminbsb/favicon.ico" type="image/x-icon">
...
<body class="login-page">
    ...
    <script src="vendor/adminbsb/plugins/jquery-validation/jquery.validate.js"></script>

    <!-- Custom Js -->
    <script src="vendor/adminbsb/js/admin.js"></script>
    <script src="vendor/adminbsb/js/pages/examples/sign-in.js"></script>
</body>
