                    ...
                    <div class="col-sm-12">
                      ...
                      <form method="post" action="/karyawan/{{ $karyawan->id }}">
                        ...
                        <div class="form-group">
                            <div class="form-line">
                                <input type="text" class="form-control" placeholder="Username" id="username" name="username" value="{{ $karyawan->username }}"/>
                            </div>
                        </div>
                        <div class="form-group">
                          <div class="form-line">
                            <input type="password" class="form-control" placeholder="Password" id="password" name="password" value="{{ $karyawan->password }}"/>
                          </div>
                        </div>
                        <div class="form-group">
                              <div class="form-line">
